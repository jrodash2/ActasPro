...
urlpatterns = [
    ...
    path("sesiones/<int:sesion_id>/informes/", views.sesion_informes, name="sesion_informes"),
    path("sesiones/<int:sesion_id>/informes/nuevo/", views.informe_create, name="informe_create"),
    path("informes/<int:pk>/editar/", views.informe_edit, name="informe_edit"),
    ...
    path("pendientes/<int:pk>/editar/", views.pendiente_edit, name="pendiente_edit"),
    path("acuerdos/", views.acuerdo_list, name="acuerdo_list"),
    path("acuerdos/nuevo/", views.acuerdo_create, name="acuerdo_create"),
    path("acuerdos/<int:pk>/editar/", views.acuerdo_edit, name="acuerdo_edit"),
